...
class Agent(Module):
    ...
    def infer_policies_efe_curiosity(self, qs: List,rng_key=None):
        ...
        q_pi, G, PBS,PBS_st, PKLD, PFE, oRisk, PBS_pA, PBS_pB,I_A_o,I_B_o,H_qs = vmap(infer_policies)(
            latest_belief, 
            self.A,
            self.B,
            self.C,
        ...
        #print(PBS)
        return q_pi, G, PBS, PBS_st,PKLD, PFE, oRisk, PBS_pA, PBS_pB,I_A_o,I_B_o,H_qs